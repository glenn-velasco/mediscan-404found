...
return [
    ...
    'laravel' => [
        ...
        // This API handles sensitive medical data, so the generated docs (and "Try It Out" feature)
        // are restricted to local/staging environments rather than being publicly reachable.
    ...
    'try_it_out' => [
        // Disabled: the "Send Request" button fires real requests against the live app/database
        // (not sandboxed or rolled back like scribe:generate's own response calls), so it can create
        // real records (e.g. registering real users) for anyone with docs access.
        'enabled' => false,
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token from the response of the <b>Login</b> or <b>Register</b> endpoint.',
    ],
