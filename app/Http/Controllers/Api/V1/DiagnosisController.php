...
class DiagnosisController extends Controller
{
     ...
     *
     * @response 200 {"status":200,"message":"Success","data":[{"id":"9b1f1c2e-6b7a-4c3a-9c2e-1a2b3c4d5e6f","condition":"Type 2 Diabetes","date_of_diagnosis":"2020-05-01","severity":"chronic","created_at":"2026-07-22T00:00:00.000000Z","updated_at":"2026-07-22T00:00:00.000000Z"}]}
     */
    ...
    /**
     * Creates a diagnosis on the authenticated user's own linked medical information record.
     *
     ...
     *
     * @response 201 {"status":201,"message":"Diagnosis created.","data":{"id":"9b1f1c2e-6b7a-4c3a-9c2e-1a2b3c4d5e6f","condition":"Type 2 Diabetes","date_of_diagnosis":"2020-05-01","severity":"chronic","created_at":"2026-07-22T00:00:00.000000Z","updated_at":"2026-07-22T00:00:00.000000Z"}}
    ...
    {
        $diagnosis = $this->diagnosisService->create($request->validated(), $request->user());
     ...
     * @bodyParam severity string One of: chronic, ongoing, acute, critical.
     *
     * @response 200 {"status":200,"message":"Diagnosis updated.","data":{"id":"9b1f1c2e-6b7a-4c3a-9c2e-1a2b3c4d5e6f","condition":"Type 2 Diabetes","date_of_diagnosis":"2020-05-01","severity":"chronic","created_at":"2026-07-22T00:00:00.000000Z","updated_at":"2026-07-22T00:00:00.000000Z"}}
     * @response 404 {"status":404,"message":"Not found.","errors":null}
     */
